...
/*循环绘制，直到关闭*/
	while (!glfwWindowShouldClose(window))
	{
		...
		//cout << material_1.specular.x << ' ' << material_1.specular.y << ' ' << material_1.specular.z << endl;
		...
		Lightmodel = glm::translate(Lightmodel, Dirlight.Light_Pos_dir);
...
#pragma endregion
		...
		//shader->SetVec3("material.diffuse", material_1.diffuse);
		//shader->SetVec3("material.specular", material_1.specular);
